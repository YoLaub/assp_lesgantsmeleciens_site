...
const disciplines = [
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach1/400/400",
    category: "boxe",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline1a/1200/800",
      "https://picsum.photos/seed/discipline1b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach2/400/400",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline2a/1200/800",
      "https://picsum.photos/seed/discipline2b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach3/400/400",
    category: "pieds-poings",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline3a/1200/800",
      "https://picsum.photos/seed/discipline3b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach4/400/400",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline4a/1200/800",
      "https://picsum.photos/seed/discipline4b/1200/800",
    ],
    seo: {
  ...
  },
  {
    title: "Cardio-Boxing",
    coach: "Amina Chérif",
    photo_coach: "https://picsum.photos/seed/coach5/400/400",
    category: "fitness",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline5a/1200/800",
      "https://picsum.photos/seed/discipline5b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    coach: "Sophie Martin",
    photo_coach: "https://picsum.photos/seed/coach6/400/400",
    category: "boxe",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline6a/1200/800",
      "https://picsum.photos/seed/discipline6b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach7/400/400",
    category: "mixte",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline7a/1200/800",
      "https://picsum.photos/seed/discipline7b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach8/400/400",
    category: "fitness",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline8a/1200/800",
      "https://picsum.photos/seed/discipline8b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach9/400/400",
    category: "boxe",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline9a/1200/800",
      "https://picsum.photos/seed/discipline9b/1200/800",
    ],
    seo: {
  ...
  },
  {
    ...
    photo_coach: "https://picsum.photos/seed/coach10/400/400",
    category: "pieds-poings",
    ...
    active: true,
    photo: [
      "https://picsum.photos/seed/discipline10a/1200/800",
      "https://picsum.photos/seed/discipline10b/1200/800",
    ],
    seo: {
...
async function main() {
  ...
  const { count: deleted } = await prisma.discipline.deleteMany();
  console.log(`Deleted ${deleted} existing disciplines.`);

  console.log("Inserting disciplines...");
  const { count } = await prisma.discipline.createMany({ data: disciplines });
  console.log(`Inserted ${count} disciplines.`);
}
